...
export const INITIAL_SUBSCRIPTIONS: Subscription[] = [
  {
    ...
    plan: 'yearly',
    status: 'active',
    renewalDate: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Expiring in 2 days!
...
export const INITIAL_PROJECTS: Project[] = [
  // ── client@restaurant.com — 3 projects under ORD-8942 ──────────────────────
  {
    ...
    description: 'Ultra-realistic 3D AR menu model showcasing sizzle, texture, and wine pairing for table display.',
    status: 'Completed',
    productImageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80',
    ...
    notes: 'Scan approved by client. Polygon count optimized for iOS Quick Look and Android WebXR.'
  },
  {
    id: 'proj-8942-2',
    orderId: 'ORD-8942',
    ...
    productCategory: 'AuRa AR Menu',
    description: 'Dynamic AR dessert showcase featuring oozing chocolate animation.',
    status: 'AR In Progress',
    productImageUrl: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    productImageUrl: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&w=800&q=80',
  ...
  // ── realestate@apex.com — 1 project under ORD-5501 ─────────────────────────
  {
    ...
    description: '360 degree 3D digital twin spatial walkthrough for penthouse sales presentation.',
    status: 'Completed',
    productImageUrl: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80',
  ...
  // Demonstrates: login with either ORD-7710 or ORD-7711 → dashboard shows both
  {
    ...
    productCategory: 'Teleport 3D Twin',
    description: 'Full spatial 3D digital twin of the Nova co-working flagship space for virtual leasing.',
    status: 'Quality Check',
    productImageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    productCategory: 'AuRa AR Menu',
    description: 'AR product showcase for Nova\'s signature modular office pod line.',
    status: 'Uploaded',
    productImageUrl: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=800&q=80',
...
export const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    ...
    message: 'Your Signature Wagyu Steak AR Experience has been completed and verified.',
    type: 'success',
    read: false,
  ...
  },
  {
    ...
    message: 'Your Bomato AuRa AR subscription expires in 2 days. Renew to maintain live QR access.',
    type: 'warning',
    read: false,
  ...
  },
  {
    ...
    message: 'Retro Cafe has requested subscription renewal. Review and confirm in the Subscriptions panel.',
    type: 'warning',
    read: false,
